    class AppState {
        ...
        loadInitialData() {
            ...
            const savedState = localStorage.getItem('microcubitasState');
            if (savedState) {
        ...
        saveToLocalStorage() {
            localStorage.setItem('microcubitasState', JSON.stringify({
                cart: this.cart,
    ...
    class AuthManager {
        static login(userType, email, password) {
            ...
            const user = {
                email: email,
                role: userType,
                name: userType === 'cliente' ? 'Cliente Usuario' : 'Administrador'
            };
